...
@section('page-title', 'تعديل الخاصية')
        ...
        <div class="bg-white rounded-lg shadow-sm border border-gray-200">
            <div class="px-6 py-4 border-b border-gray-200">
                <div class="flex items-center justify-between">
                    <h3 class="text-lg font-semibold text-gray-900">تعديل الخاصية: {{ $feature->title }}</h3>
            ...
            <form method="POST" action="{{ route('admin.about-us-features.update', $feature) }}" enctype="multipart/form-data" class="p-6">
                @csrf
                @method('PUT')
