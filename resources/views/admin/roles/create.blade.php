                    ...
                    <div class="space-y-6 lg:col-span-2">
                        ...
                        <table class="min-w-full divide-y divide-gray-200 border">
                            <thead class="bg-gray-50">
                                <tr>
                                    <th class="px-4 py-2 text-right text-xs font-medium text-gray-500 uppercase tracking-wider">النموذج</th>
                                    <th class="px-4 py-2 text-right text-xs font-medium text-gray-500 uppercase tracking-wider">إضافة</th>
                                    <th class="px-4 py-2 text-right text-xs font-medium text-gray-500 uppercase tracking-wider">عرض</th>
                                    <th class="px-4 py-2 text-right text-xs font-medium text-gray-500 uppercase tracking-wider">تعديل</th>
                                    <th class="px-4 py-2 text-right text-xs font-medium text-gray-500 uppercase tracking-wider">حذف</th>
                                </tr>
                            </thead>
                            <tbody>
                                @php
                                    $models = [
                                        'منتج', 'تصنيف', 'استفسار', 'معلومات الشركة', 'محتوى من نحن', 'ميزة من نحن', 'شريك', 'سلايدر', 'تواصل', 'مواصفة المنتج', 'مستخدم',
                                    ];
                                    ...
                                    <tr>
                                        ...
                                        @foreach ($actions as $action)
                                            <td class="px-4 py-2 text-center">
                                                <input type="checkbox" name="permissions[]" value="{{ $action . ' ' . $model }}">
                                            </td>
                                        @endforeach
                                    </tr>
                                @endforeach
