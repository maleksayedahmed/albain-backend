...
<div class="fixed bottom-24 left-6 z-40">
    ...
    <div id="contact-options"
        class="absolute bottom-20 left-0 space-y-3 opacity-0 invisible transform translate-y-4 transition-all duration-300">
        <!-- WhatsApp Button -->
        <div class="flex items-center justify-start">
            <span
                class="bg-white px-3 py-1 rounded-lg shadow-md text-sm font-medium text-gray-800 whitespace-nowrap">محادثة
                عبر الواتس اب</span>
            <a href="https://wa.me/{{ preg_replace('/[^0-9]/', '', $companyInformation->whatsapp) }}" target="_blank"
                rel="noopener"
                class="flex items-center justify-center w-14 h-14 rounded-full bg-[#2AA25A] shadow-lg ml-3 transform hover:scale-110 transition-transform duration-300">
        ...
        <div class="flex items-center justify-start">
            <span
                class="bg-white px-3 py-1 rounded-lg shadow-md text-sm font-medium text-gray-800 whitespace-nowrap">اتصال
                جوال</span>
            <a href="tel:{{ preg_replace('/[^0-9+]/', '', $companyInformation->phone) }}"
                class="flex items-center justify-center w-14 h-14 rounded-full bg-[#306A8E] shadow-lg ml-3 transform hover:scale-110 transition-transform duration-300">
