            ...
            <form method="POST" action="{{ route('admin.products.store') }}" enctype="multipart/form-data" class="p-6">
                ...
                <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
                    ...
                    <div class="space-y-6">
                        <!-- Thumbnail Upload -->
                        <div>
                            <label for="thumbnail" class="block text-sm font-medium text-gray-700 mb-2">صورة الغلاف (الصورة
                                الرئيسية)</label>
                            <div
                                ...
                                <div class="space-y-1 text-center">
                                    ...
                                    <p class="text-xs text-gray-500">PNG, JPG, GIF حتى 2MB. هذه ستكون الصورة الرئيسية
                                        للمنتج.</p>
                                </div>
                            </div>
                            @error('thumbnail')
                            ...
                            <div id="thumbnailPreview" class="mt-4 hidden">
                                <img id="thumbnailImg" src="" alt="صورة الغلاف"
                        ...
                        <!-- Gallery Upload -->
                        <div>
                            <label for="gallery_images" class="block text-sm font-medium text-gray-700 mb-2">معرض الصور (صور
                                إضافية للمنتج)</label>
                            <div
                                class="mt-1 flex justify-center px-6 pt-5 pb-6 border-2 border-gray-300 border-dashed rounded-lg hover:border-gray-400 transition-colors">
                                <div class="space-y-1 text-center">
                                    ...
                                    <p class="text-xs text-gray-500">PNG, JPG, GIF حتى 2MB لكل صورة. يمكنك رفع أكثر من
                                        صورة.</p>
                                </div>
                            </div>
